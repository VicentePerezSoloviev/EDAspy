...
class SPEDA(EDA):
    ...
    Algorithm uses a semiparametric Bayesian network which allows dependencies between variables
    ...
    Example:
        ...
        .. code-block:: python
            ...
            egna = SPEDA(size_gen=300, max_iter=100, dead_iter=20, n_variables=10,
